    ...
    <div className="bg-white">
      <section className="mx-auto max-w-4xl overflow-hidden rounded-3xl shadow-lg md:grid md:grid-cols-2">
        ...
        <div className="relative px-10 py-14">
          ...
          <button className="mt-10 inline-flex items-center gap-2 rounded-full bg-rose-500 px-8 py-3 text-sm font-semibold text-white transition-colors hover:bg-rose-600 focus:outline-none focus:ring-2 focus:ring-rose-400">
